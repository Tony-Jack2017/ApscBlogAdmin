...
import {ComForm, ComFormItem} from "../../components/ComForm";
...
const Access = () => {
    ...
    const handleSwitch = (formNo: number) => {
        console.log(formNo)
        if (formNo === 1) { setFormClass1(classNames("form", "switched")); setFormClass2("form") }
        if (formNo === 2) { setFormClass2(classNames("form", "switched")); setFormClass1("form") }
    }
