...
export interface CumMenuItemType extends MenuItemType {
    [propName: string]: any;
}

function getItem( label: React.ReactNode, key: React.Key, icon?: React.ReactNode, children?: MenuItem[], type?: "group", active?: boolean ): MenuItem {
    return { key, icon, children, label, type, active } as MenuItem
}
